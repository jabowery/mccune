...
static Prover_options Opt;               // mccune options
static struct prover_attributes Att;     // mccune accepted attributes
static struct prover_stats Stats;        // mccune statistics
static struct prover_clocks Clocks;      // mccune clocks
